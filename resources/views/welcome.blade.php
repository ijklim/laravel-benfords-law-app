...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <!--
            ...
            • https://cdnjs.com/libraries/vue/2.6.14
            • https://cdnjs.com/libraries/vuetify/3.0.0-alpha.11
        -->

        <!-- CSS -->
        <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/vuetify/3.0.0-alpha.11/vuetify.min.css" integrity="sha512-zkwvoYgk0zeatsVzNoQMfs2SzjxaDgyX3oHMILVxTA9+QzJCYtERGmJmN4VWBaAhzajP8oX4XwTV1RArFVNMbA==" crossorigin="anonymous" referrerpolicy="no-referrer" />
